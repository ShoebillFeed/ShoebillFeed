...
def generate_podcast_episode(show_id: str) -> str:
    ...
    try:
        ...
        try:
            from app.services.podcast_script import select_episode_items, build_script
            ...
            for i, turn in enumerate(script.turns):
                ...
                result = tts.synthesize(turn.text, host["voice"], out_path)
            ...
            episode.script = [{"host_id": t.host_id, "text": t.text} for t in script.turns]
