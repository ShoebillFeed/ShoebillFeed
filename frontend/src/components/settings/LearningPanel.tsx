  ...
  return (
    <div>
      ...
      >
        ...
        {update.isError && (
          <p className="text-xs text-red-500">{t("advanced.settingsFailed")}</p>
        )}
      </Accordion>

      {/* Section 4: Algorithm Tuning */}
      <Accordion
        title={t("learning.algorithmTitle")}
        description={t("learning.algorithmDesc")}
        action={
          <button
            onClick={() =>
              update.mutate({
