...
import { BellOff, Check, AlertTriangle, Copy, Trash2, ChevronDown, ChevronRight, KeyRound } from "lucide-react";
...
function ApiTokensSection() {
  ...
  return (
    <div className="mb-8">
      ...
      {open && (
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4 flex flex-col gap-6">
